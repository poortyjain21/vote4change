...
public class ShowUserDetailsControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(uid != null && uid.equalsIgnoreCase("uid"))
            {
              ArrayList<String> list = UserDAO.getUserId();
              request.setAttribute("result","id") ; 
              request.setAttribute("uid",list);
              rd = request.getRequestDispatcher("showuserid.jsp");
            }
            
            else{
            ArrayList<UserInfo> userList = UserDAO.getUserDetails();
